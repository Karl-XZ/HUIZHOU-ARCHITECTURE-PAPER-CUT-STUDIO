export interface EdgeOneKvNamespace {
  put(
    key: string,
...
export interface EdgeOneFunctionContext {
  request: Request;
...
export function getBinding<T>(context: EdgeOneFunctionContext, name: string): T | undefined {
...
export function getEnvString(context: EdgeOneFunctionContext, name: string): string | undefined {
